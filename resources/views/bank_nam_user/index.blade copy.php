            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                        <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">ผูกบัญชีธนาคาร</h4>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <form role="form" class="text-start" method="POST" action="{{ 'add-bank_name_user' }}">
                                    ...
                                    <div class="input-group input-group-outline my-3">
                                        ...
                                        <input type="text" class="form-control " name="bank_user" required>
                                    </div>
                                    <div class="input-group input-group-outline my-3">
                                        <label class="form-label">หมายเลขบัญชี</label>
                                        <input type="text" class="form-control " name="bank_numbar_user" required>
                                    </div>
                                    <div class="input-group input-group-outline my-3">
